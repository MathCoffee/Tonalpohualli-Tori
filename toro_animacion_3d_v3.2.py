...
for cat_key in trace_keys:
    ...
    fig.add_trace(go.Scatter3d(
        ...
        textfont=dict(color='#1E3A5F', size=11, family='Arial, sans-serif'),
        hovertext=cat['hover'],
        hoverinfo='text',
...
fig.update_layout(
    ...
    paper_bgcolor='white',
    plot_bgcolor='white',
    margin=dict(l=10, r=220, b=10, t=55),
    ...
    <script>
        ...
        function setRepresentation(mode) {
            ...
            if (plotDiv) {
                ...
                const fontColor = mode === 'numeros' ? '#1E3A5F' : '#000000';
                // También forzar modo markers+text para que las etiquetas sean visibles
