...
fig.add_trace(go.Scatter3d(
    ...
    mode='lines',
    line=dict(color='#FFEAA7', width=3.5),
    opacity=0.75,
    name='Trayectoria',
    hoverinfo='skip'
))
...
fig.add_trace(go.Scatter3d(
    ...
    text=["(1,1)"],
    textposition="top center",
    textfont=dict(color='#FF7675', size=11, family='Arial Black'),
...
sliders = [dict(
    ...
    currentvalue=dict(font=dict(size=14, color='white'), prefix="Día Actual (n): ", visible=True, xanchor="right"),
...
fig.write_html("toro_animacion_3d_v2_1.html")
print("¡toro_animacion_3d_v2_1.html creado exitosamente!")
